...
## Conhecimentos Básicos Extras / Extra Basic Skills

<details align="left">
  <summary style="cursor: pointer; font-weight: bold; font-size: 16px; padding: 10px; background: #222; color: #fff; border-radius: 5px; width: max-content;">
    Mostrar (Clique) / Show (Click)
  </summary>
  <br>
